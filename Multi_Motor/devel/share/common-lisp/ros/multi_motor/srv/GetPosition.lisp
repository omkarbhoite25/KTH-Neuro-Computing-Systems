...
(cl:defmethod cl:initialize-instance :after ((m <GetPosition-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetPosition-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name multi_motor-srv:<GetPosition-request> is deprecated: use multi_motor-srv:GetPosition-request instead.")))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <GetPosition-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader multi_motor-srv:id-val is deprecated.  Use multi_motor-srv:id instead.")
  (id m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetPosition-request>)))
  ...
  "multi_motor/GetPositionRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetPosition-request)))
  "Returns string type for a service object of type 'GetPosition-request"
  "multi_motor/GetPositionRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <GetPosition-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetPosition-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name multi_motor-srv:<GetPosition-response> is deprecated: use multi_motor-srv:GetPosition-response instead.")))

(cl:ensure-generic-function 'position-val :lambda-list '(m))
(cl:defmethod position-val ((m <GetPosition-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader multi_motor-srv:position-val is deprecated.  Use multi_motor-srv:position instead.")
  (position m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetPosition-response>)))
  ...
  "multi_motor/GetPositionResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetPosition-response)))
  "Returns string type for a service object of type 'GetPosition-response"
  "multi_motor/GetPositionResponse")
